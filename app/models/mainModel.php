<?php
//funciones principales que se usan mas de una vez conexion a bbd consultas y excpresiones regulares 
    ...
    class mainModel{
        ...
        public function seleccionarDatos($tipo, $tabla, $campo, $id){
            ...
            if ($tipo == "Unico") {
                $sql = $this->conectar()->prepare("SELECT * FROM $tabla WHRE 
                $campo = :ID");
                $sql->bindParam(":ID", $id);
            } elseif($tipo == "Normal") {
        ...
        protected function actualizarDatos($tabla, $datos, $condicion){
            ...
            $sql->bindParam($condicion["condicion_marcador"],
        ...
        protected function eliminarRegistro($tabla, $campo, $id){
            $sql = $this->conectar()->prepare("DELETE FROM $tabla WHERE 
            $campo=:id");
            $sql->bindParam(":id",$id);
            $sql->execute();
        ...
        protected function paginadorTablas($pagina, $numeroPaginas, $url,
         $botones){
            ...
            //if ($pagina == $numeroPaginas || $pagina == $numeroPaginas-1 ) {
            if ($pagina == $numeroPaginas) {
                ...
                $tabla .='
                    ...
                    <li>
                        <a class="pagination-link" 
                        href="'.$url.$numeroPaginas.'/">'.$numeroPaginas.'</a>
                    </li>
                </ul>
